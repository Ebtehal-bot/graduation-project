...
>
    <head>
        ...
        <?php
            $faviconPath = config('filament.favicon');
            if (!$faviconPath) {
                $siteFavicon = \App\Models\Setting::getValue('site_favicon', '');
                if (!empty($siteFavicon)) {
                    $faviconPath = asset('storage/' . $siteFavicon);
                }
            }
        ?>
        <?php if($faviconPath): ?>
...
<?php /**PATH C:\Users\DELL\Desktop\مشروع التخرج\orphan-system\resources\views/vendor/filament/components/layouts/base.blade.php ENDPATH**/ ?>