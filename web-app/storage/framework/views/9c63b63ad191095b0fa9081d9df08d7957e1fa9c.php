...
} elseif ($_instance->childHasBeenRendered('Q7UkpVp')) {
    $componentId = $_instance->getRenderedChildComponentId('Q7UkpVp');
    $componentTag = $_instance->getRenderedChildComponentTagName('Q7UkpVp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Q7UkpVp');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('Q7UkpVp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\Users\DELL\Desktop\تبع براءه\orphan-system\resources\views/vendor/filament/components/topbar.blade.php ENDPATH**/ ?>