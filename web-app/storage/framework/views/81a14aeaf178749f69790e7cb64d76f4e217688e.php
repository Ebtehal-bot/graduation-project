...
<div style="padding:12px 0;">
    <table style="width:100%;border-collapse:collapse;">
        ...
        <tbody>
                    ...
                    <td style="text-align:center;padding:12px 8px;border-bottom:1px solid #eee;">
                        <?php if($orphan->academic_result): ?>
                            <div style="display:flex;gap:8px;justify-content:center;">
                                <a href="<?php echo e(asset('storage/' . $orphan->academic_result)); ?>" target="_blank"
                ...
                <tr>
                    ...
                    <td style="text-align:center;padding:12px 8px;border-bottom:1px solid #eee;">
                        <?php if($orphan->thank_you_letter): ?>
                            <div style="display:flex;gap:8px;justify-content:center;">
                                <a href="<?php echo e(asset('storage/' . $orphan->thank_you_letter)); ?>" target="_blank"
            ...
            <?php $__currentLoopData = $primaryTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $doc = $docs[$type] ?? null; ?>
                <tr>
                    <td style="padding:12px 8px;border-bottom:1px solid #eee;font-size:14px;"><?php echo e($label); ?></td>
                    <td style="text-align:center;padding:12px 8px;border-bottom:1px solid #eee;">
                        <?php if($doc): ?>
                            <div style="display:flex;gap:8px;justify-content:center;">
                                <?php if($doc['canView']): ?>
                                ...
                                <?php endif; ?>
                                <a href="<?php echo e(route('attachments.download', $doc['id'])); ?>"
            ...
            <?php $__currentLoopData = $attachmentsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    $path = \App\Models\Attachment::normalizeFile($a->file_path);
                    $type = $a->document_type;
                ?>
                <?php if(!$path || isset($primaryTypes[$type])) continue; ?>
                <tr>
                    <td style="padding:12px 8px;border-bottom:1px solid #eee;font-size:14px;">
                        <?php echo e($a->document_type ?? 'مستند'); ?>
                    ...
                    <td style="text-align:center;padding:12px 8px;border-bottom:1px solid #eee;">
                        <div style="display:flex;gap:8px;justify-content:center;">
                            ...
                            <?php endif; ?>
                            <a href="<?php echo e(route('attachments.download', $a->id)); ?>"
                               style="display:inline-block;padding:6px 16px;background:#22c55e;color:#fff;border-radius:4px;text-decoration:none;font-size:13px;font-weight:bold;">
                                تحميل
                            </a>
                        </div>
...
</div><?php /**PATH C:\Users\DELL\Desktop\تبع براءه\orphan-system\resources\views/filament/orphan-documents.blade.php ENDPATH**/ ?>