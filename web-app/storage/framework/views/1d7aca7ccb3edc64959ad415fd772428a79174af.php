...
<body>
    ...
    <div class="header">
        ...
        <h2><?php echo e($org); ?></h2>
        <h3>كشف أيتام: <?php echo e($record->name); ?></h3>
        <p>محافظة <?php echo e($record->governorate); ?></p>
    </div>
    ...
    <table>
        ...
        <tbody>
            <?php $totalAmount = 0; ?>
            <?php $__currentLoopData = $orphans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $orphan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
            ...
            <tr>
                ...
                <td style="font-weight: bold;"><?php echo e($orphan->name); ?></td>
                <td><?php echo e($orphan->sponsorship->sponsor->name ?? 'غير مكفول'); ?></td>
                <td style="color: #1a237e; font-weight: bold;"><?php echo e(number_format($amount)); ?></td>
            ...
            <tr style="background-color: #f0f4ff; font-weight: bold; border-top: 2px solid #1a237e;">
                ...
                <td style="color: #1a237e;"><?php echo e(number_format($totalAmount)); ?> ريال</td>
                <td></td>
            </tr>
        </tbody>
    </table>
    ...
    <div class="footer">
        <?php if(!empty($mgr)): ?> مدير المؤسسة: <?php echo e($mgr); ?> <?php endif; ?>
        <?php if(!empty($mgrPhone)): ?> | هاتف: <?php echo e($mgrPhone); ?> <?php endif; ?>
        <?php if(!empty($mgrEmail)): ?> | البريد: <?php echo e($mgrEmail); ?> <?php endif; ?>
    </div>
</body>
</html><?php /**PATH C:\Users\DELL\Desktop\تبع براءه\orphan-system\resources\views/reports/branch_orphans_report.blade.php ENDPATH**/ ?>