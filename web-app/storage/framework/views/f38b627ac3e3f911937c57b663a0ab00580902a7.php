    ...
    <section class="gradient-hero min-h-screen flex items-center relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10 w-full">
            <div class="text-center">
                ...
                <a href="/admin/login"
                   class="inline-block bg-emerald-500 hover:bg-emerald-400 text-white font-bold px-10 py-4 rounded-xl text-lg btn-primary shadow-lg">
                    ابدأ الكفالة الآن
                </a>
            </div>
        </div>
    ...
    <footer class="bg-primary text-white">
        <div class="container mx-auto px-6 py-12">
                ...
                <div class="text-left md:text-left">
                    ...
                    <ul class="space-y-4 text-lg">
                        ...
                        <li class="flex items-center justify-start gap-3 flex-row-reverse">
                            ...
                            <span dir="ltr" class="text-indigo-200"><?php echo e($settings->phone); ?></span>
                        </li>
                        <?php endif; ?>
                        ...
                        <li class="flex items-center justify-start gap-3 flex-row-reverse">
                            ...
                            <a href="mailto:<?php echo e($settings->email); ?>" class="text-indigo-200 hover:text-white transition"><?php echo e($settings->email); ?></a>
                        </li>
                        <?php endif; ?>
                        ...
                        <li class="flex items-center justify-start gap-3 flex-row-reverse">
                            ...
                            <a href="https://wa.me/<?php echo e($settings->whatsapp); ?>" target="_blank" class="text-indigo-200 hover:text-white transition"><?php echo e($settings->whatsapp); ?></a>
                        </li>
                        <?php endif; ?>
                    </ul>
                    <div class="flex gap-6 justify-start mt-4">
                        <?php if(!empty($settings->facebook)): ?>
                        <a href="<?php echo e($settings->facebook); ?>" target="_blank" class="text-indigo-300 hover:text-white transition">
                        ...
                        <a href="<?php echo e($settings->twitter); ?>" target="_blank" class="text-indigo-300 hover:text-white transition">
                        ...
                        <a href="<?php echo e($settings->instagram); ?>" target="_blank" class="text-indigo-300 hover:text-white transition">
                        ...
                        <a href="<?php echo e($settings->youtube); ?>" target="_blank" class="text-indigo-300 hover:text-white transition">
            ...
            <div class="border-t border-indigo-800 mt-8 pt-8 text-center text-indigo-300 text-sm">
                &copy; <?php echo e(date('Y')); ?> منصة كفيل لرعاية الأيتام. جميع الحقوق محفوظة.
            </div>
        </div>
    </footer>
...
<?php /**PATH C:\Users\NEW RAM\Desktop\orphan-system\resources\views/welcome.blade.php ENDPATH**/ ?>