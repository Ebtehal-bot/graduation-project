...
} elseif ($_instance->childHasBeenRendered('2jx9gT3')) {
    $componentId = $_instance->getRenderedChildComponentId('2jx9gT3');
    $componentTag = $_instance->getRenderedChildComponentTagName('2jx9gT3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2jx9gT3');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('2jx9gT3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH C:\Users\DELL\Desktop\تبع براءه\orphan-system\resources\views/vendor/filament/components/layouts/card.blade.php ENDPATH**/ ?>