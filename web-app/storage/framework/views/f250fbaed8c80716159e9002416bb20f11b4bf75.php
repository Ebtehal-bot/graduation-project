...
} elseif ($_instance->childHasBeenRendered('1nnYrNs')) {
    $componentId = $_instance->getRenderedChildComponentId('1nnYrNs');
    $componentTag = $_instance->getRenderedChildComponentTagName('1nnYrNs');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1nnYrNs');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('1nnYrNs', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH C:\Users\DELL\Desktop\مشروع التخرج\orphan-system\resources\views/vendor/filament/components/layouts/card.blade.php ENDPATH**/ ?>