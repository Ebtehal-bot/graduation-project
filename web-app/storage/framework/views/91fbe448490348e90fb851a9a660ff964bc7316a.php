...
} elseif ($_instance->childHasBeenRendered('4tr5DZA')) {
    $componentId = $_instance->getRenderedChildComponentId('4tr5DZA');
    $componentTag = $_instance->getRenderedChildComponentTagName('4tr5DZA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4tr5DZA');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('4tr5DZA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\Users\DELL\Desktop\مشروع التخرج\orphan-system\resources\views/vendor/filament/components/topbar.blade.php ENDPATH**/ ?>