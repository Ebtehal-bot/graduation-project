...
} elseif ($_instance->childHasBeenRendered('gzv8BJJ')) {
    $componentId = $_instance->getRenderedChildComponentId('gzv8BJJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('gzv8BJJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('gzv8BJJ');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('gzv8BJJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\Users\NEW RAM\Desktop\orphan-system\resources\views/vendor/filament/components/topbar.blade.php ENDPATH**/ ?>