...
} elseif ($_instance->childHasBeenRendered('GulUUxN')) {
    $componentId = $_instance->getRenderedChildComponentId('GulUUxN');
    $componentTag = $_instance->getRenderedChildComponentTagName('GulUUxN');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GulUUxN');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('GulUUxN', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH C:\Users\NEW RAM\Desktop\orphan-system\resources\views/vendor/filament/components/layouts/card.blade.php ENDPATH**/ ?>